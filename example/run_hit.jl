...
function hit(L, N, M; load=false, length_scale=1, velocity_scale=1, cbc_path="cbc_spectrum.dat", ν=1.48e-5, λ=quick, mem=Array, T=Float32)
...
function main()
    ...
    sim = hit(L, N, modes; load, length_scale, velocity_scale, cbc_path, ν=ν_numerical, λ, mem, T)
